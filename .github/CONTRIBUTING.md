...
1. [Fork](https://github.com/crazy-max/ghaction-hugo/fork) and clone the repository
...
10. Push to your fork and [submit a pull request](https://github.com/crazy-max/ghaction-hugo/compare)
